...
| **6** | Card decoration & theme | #14 Decoration/ornamentation, #15 Deck-wide theme/symbolism, #5 Composition/rhythm *(partial)* | Decor.pip, Ornaments.pip, Frame.pip (toggle); Highlights.\* (+extra); `ornaments_extra`/`highlights_extra` (incl. theme-derived) | feeds `[STYLE_BLOCK]` (extra phrases), `[FRAME_LINE]` (pip) | `references/REFERENCE.md` ("Theme-derived ornaments/highlights") |

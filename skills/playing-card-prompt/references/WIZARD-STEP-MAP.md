...
| **8** | Figure proportion / framing | #5 Composition/rhythm *(figure framing/cropping)* | Figure *(gated by `layers.figure.<group>`)* | feeds `[STYLE_BLOCK]` (`figure_proportion` line, appended after Face Style/`extras.figure`) | `assets/figure-proportion/<name>.md` |
